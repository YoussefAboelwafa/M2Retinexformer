...
"""
    ...
    version_file_str = content.format(
        time.asctime(), VERSION, SHORT_VERSION, VERSION_INFO
    )
...
def make_cuda_ext(name, module, sources, sources_cuda=None):
    try:
        ...
        # If torch is not available, return None to skip CUDA extensions
        return None
...
if __name__ == "__main__":
    ...
    # Try to import BuildExtension, use None if not available
    try:
